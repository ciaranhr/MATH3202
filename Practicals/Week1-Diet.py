...
Foods = ['almonds', 'apples', 'apricots', 'banana', 'brie', 'broccoli', 
         ...
         'cous cous', 'cream cheese', 'croissants', 'cucumber', 'currants', 
...
C = [1.33, 0.59, 0.69, 0.40, 2.24, 0.75, 0.32, 2.24, 0.19, 1.10, 3.33, 
     0.40, 1.24, 1.51, 0.49, 1.65, 0.28, 3.33, 0.80, 1.09, 1.70, 1.10, 
     2.67, 1.44, 1.30, 2.82, 1.00, 0.60, 0.43, 0.18]
